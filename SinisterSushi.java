...
/**
 * The SinisterSushi class extends Actor to make a distinction from the FeudalFighters class.
 * The SinisterSushi have movement abilities and methods to detect collisions which differ from 
 * the stationary fighters.
 * 
 * @author Sam Christensen
 * @author Jack Doughty
 */
public class SinisterSushi extends Actor {
	 ...
	 */
	public SinisterSushi(Double startingPosition, Point2D.Double initHitbox, BufferedImage img, int health, int coolDown, double speed, int attackDamage) {
	...
	public void setCollisionStatus(Actor other) {
		if ((other instanceof Sumo || other instanceof Samurai) && this.isCollidingOther(other)) {
			setColliding(true);
		}
	}
